<?php
class ExtDirect_API {
    protected $_routerUrl = 'router.php';
    protected $_cacheProvider = null;
    protected $_defaults = array();
    protected $_classes = array();
    protected $_remoteAttribute = '@remotable';
    protected $_formAttribute = '@formHandler';
    protected $_nameAttribute = '@remoteName';
    protected $_namespace = false;
    protected $_type = 'remoting';
    protected $_parsedClasses = array();
    protected $_parsedAPI = array();
    protected $_descriptor = 'Ext.app.REMOTING_API';
